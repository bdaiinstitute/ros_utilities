...
5. Add the following lines to `package.xml` after the existing `<buildtool_depend>`:
   ...
   ```
   Your `package.xml` file should now look like:
   ```xml
   <?xml version="1.0"?>
   <?xml-model href="http://download.ros.org/schema/package_format3.xsd" schematypens="http://www.w3.org/2001/XMLSchema"?>
   <package format="3">
     <name>synchros2_tutorials_interfaces_example</name>
     <version>0.0.0</version>
     <description>TODO: Package description</description>
     <maintainer email="jbarry@theaiinstitute.com">jbarry</maintainer>
     <license>MIT</license>
