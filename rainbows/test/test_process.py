...
import rainbows.process as process
from rainbows.static_transform_broadcaster import StaticTransformBroadcaster
...
def test_cli_configuration() -> None:  # type: ignore
    ...
    with mock.patch("rainbows.scope.logs_to_ros") as logs_to_ros:
